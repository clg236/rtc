...
static void JNI_ChildProcessServiceImpl_RegisterFileDescriptors(JNIEnv* env,
...
JNI_GENERATOR_EXPORT void
    ...
    jlongArray offset,
    jlongArray size) {
  return JNI_ChildProcessServiceImpl_RegisterFileDescriptors(env,
...
static void JNI_ChildProcessServiceImpl_ExitChildProcess(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller);

JNI_GENERATOR_EXPORT void
    Java_org_chromium_base_process_1launcher_ChildProcessServiceImpl_nativeExitChildProcess(JNIEnv*
    env, jclass jcaller) {
  return JNI_ChildProcessServiceImpl_ExitChildProcess(env,
      base::android::JavaParamRef<jclass>(env, jcaller));
}
